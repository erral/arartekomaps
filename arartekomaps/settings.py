...
DEFAULT_FROM_EMAIL = 'Ararteko mapak <garaolaza@codesyntax.com>'
EMAIL_NOTIFICATION = 'Ararteko mapak <garaolaza@codesyntax.com>'

ADMINS = (
    # ('Gari Araolaza', 'garaolaza@codesyntax.com'),
...
DATABASES = {
    'default': {
        ...
        'NAME': 'arartekomaps',                      # Or path to database file$
        'USER': 'artkmaps_user',                      # Not used with sqlite3.
        'PASSWORD': 'fxXYIH1EHy',                  # Not used with sqlite3.
...
SECRET_KEY = 'vzj!(7gj%@y@$-=zmyc1^@sebws^_6#7g80bbo&&t^x*=vgd_z'
